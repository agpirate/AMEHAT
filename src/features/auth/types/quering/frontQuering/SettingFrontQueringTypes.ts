...
// Query slice types
export interface SettingFrontQueringTypes {

  setSearchQuery: (queries:Record<string,any>) => void;
  setGlobalQuery: (queries:Record<string,any>) => void; 
  
  setQuery: (queries:Record<string,any>) => void; 
  setFeaturedQuery: (queries:Record<string,any[]>) => void; //setclientFeaturedGroupFilters

  resetSearchQuery: (query: string) => void;
  resetQuery: (key?: string) => void; //
  resetGlobalQuery: (key: string) => void; //
}
