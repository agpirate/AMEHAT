...
export const  LatestItems = ({datas,onSelect}) =>{
                    ...
                    >
                        ...
                        (<>
                          ...
                          <Text style={[
                            ...
                            Hamas says new Gaza talks have begun, hours after Israel launched major offensive Hamas says new Gaza talks have begun, hours after Israel launched major offensive Hamas says new Gaza talks have begun, hours after Israel launched major offensive
                          </Text>
                            </View>
                        ...
                        (<TouchableOpacity style={[flexStyle.crow,flexStyle.cgap_xs,flexStyle.ia_center,boxStyle.boxStyle_xxs]}
                          onPress={()=>onSelect('fetch',item.id,inx)}
                        >
