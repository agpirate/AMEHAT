...
fetchItems,
  ...
  <SafeAreaView style={[boxStyle.boxStyle_flat,{flex:1}]}> 
  
  {headerVisible && (
<Animated.View style={[boxStyle.boxStyle_flat,headerStyles,boxStyle.bgc_dark]}>


          <ScrollView style={[boxStyle.boxStyle_flat]} horizontal showsHorizontalScrollIndicator={false}>
            
            {Object.keys(modelGroups.categories).map((cat,index) => (
              <View key={cat}    style={[flexStyle.crow,{justifyContent: 'center', alignItems: 'center' }]}> 
                  
                  <TouchableOpacity
                   
                    style={[
                      boxStyle.boxStyle_sm,boxStyle.border_flat_system,boxStyle.p_lrmd,
                      clientQFilters.filterBasis.category === cat && boxStyle.border_bmd ,
                      flexStyle.crow,flexStyle.cj_center,flexStyle.ia_center,
                    ]}
                    onPress={()=>setFilterCategory(cat)}
                  >

                    <Text style={[
                      fontStyle.fontStyle_sm,fontStyle.fweight_bolder,fontStyle.fcolor_light,
                      clientQFilters.filterBasis.category === cat && fontStyle.fcolor_system,
                      fontStyle.f_capitalize
                    ]}
                    >
                ...
                <View
                  style={[boxStyle.boxStyle_xxs,boxStyle.bgc_systemii, {
...
{clientQFilters.filterBasis.category && 
  ...
  <ScrollView 
    ...
    style={[boxStyle.bgc_grey15,{marginTop: 8}]} // Add some spacing
  >
{Object.entries(modelGroups.categories[clientQFilters.filterBasis.category].children).map(([key, valuesObj]) => (
      <TouchableOpacity
        ...
        style={[
          ...
          boxStyle.border_flat_system, 
          boxStyle.p_lrmd,
          
          flexStyle.crow, 
          flexStyle.cj_center, 
          flexStyle.ia_center,
          // clientQFilters.filterBasis.subcategory === key && boxStyle.border_bmd,
          {marginRight: 8}
        ]}
        onPress={() => setFilterSubCategory(key)}
      >
        <Text style={[
          fontStyle.fontStyle_sm, 
          fontStyle.fweight_bolder, 
          fontStyle.fcolor_systemii,
          // clientQFilters.filterBasis.subcategory === key && fontStyle.fcolor_system,
          fontStyle.f_capitalize
        ]}>
      ...
      style={[boxStyle.boxStyle_flat,boxStyle.bgc_grey75]}
      >
