...
return (
  <View style={[boxStyles.boxStyle_xxs,]}>
    ...
    {/* Media Display Area (Video or Thumbnail) */}
    { item.videos?.url ? (
...
{/* Video Info - Now with proper text containment */}
    <View style={[styles.infoContainer,{width:windowWidth * containerW},boxStyles.boxStyle_xs]}>
      <Text style={[fontStyles.fontStyle_sm,fontStyles.fweight_bold,fontStyles.fcolor_dark]}  ellipsizeMode="tail">
        {item.title}
      ...
      <View style={styles.metaContainer}>
        <View style={styles.channelContainer}>
          ...
          <Text style={styles.channelText} numberOfLines={1}>
            { item.subcategory  && t(`${featureName}|${item['subcategory']}`)}
