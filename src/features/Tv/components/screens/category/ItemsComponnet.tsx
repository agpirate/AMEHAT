...
import { ColMediaDetailMeta_group,ColMediaDetailMeta_mini,ColMediaDetailMeta_micro} from "../../../../../shared/components/cards/featuredCards/tv/index.js"
    ...
    return (
                ...
                <View style={[boxStyles.boxStyle_flat,flexStyles.cgap_lg]}>
                  ...
                  {processedData[0] && typeof processedData[0] === 'object' && (
                      <View key={processedData[0].id} style={[{width:'100%'}]}>
                        <ColMediaDetailMeta_group item={processedData[0]} />
                      </View>
                    )}                  
                    ...
                    <View style={[{flexDirection:'row',flexWrap: 'wrap',justifyContent: 'space-between',}]}>
                      {remainingItems.map((item:Item, index:number) => (
                        typeof item === 'object' ? (
                          ...
                          >
                            <ColMediaDetailMeta_micro item={item} />
                          </TouchableOpacity>
                        ) : null
                      ))}
                      </View>
