  ...
  return (
    ...
    <>
      ...
      <newsStack.Navigator
        id={undefined}
        screenOptions={{
          headerStyle: { backgroundColor: '#937a23' },
          headerTintColor: '#fff',
          headerTitleStyle: { fontWeight: 'light' },
        }}>
        
        <newsStack.Screen name={ROUTES.MAIN_TAB.RADIO.LIST.GATEWAY}
              ...
              ()=>(
                <>
                    ...
                    <newsStack.Navigator id={undefined}>
                        <newsStack.Screen name={ROUTES.MAIN_TAB.RADIO.LIST.LATEST}           component={FeaturedScreen}        options={{ headerShown: false }} /> 
                        <newsStack.Screen name={ROUTES.MAIN_TAB.RADIO.LIST.GROUP_CATEGORY}   component={CategoryScreen}    options={{ headerShown: false }} />
                    </newsStack.Navigator>
                </>
              )
            }
        ...
        <newsStack.Screen name={ROUTES.MAIN_TAB.RADIO.DETAIL} component={DetailsScreen} 
options={({ route, navigation }) => ({ 
    title: t('radio|'+(route.params?.title ?? '')),
    headerShown: true,
    headerRight: () => (
