...
import { ColMediaDetailMeta,ColMediaRowDetailMeta,ColMediaDetailMeta_mini} from "../../../../../shared/components/cards/featuredCards/tv/index.js"
              ...
              <Text style={[fontStyles.fweight_bold]}>View All</Text>
                ...
                typeof item == 'object' ?
                    ...
                    {index == 0 ? (
                        ...
                        >
                            <ColMediaDetailMeta_mini item={item}  />     
