...
startSubFetchOperation,
      ...
      const setFilterCategoryOptions = (key:string,value:string) =>{
        ...
        if(key == 'category'){
          ...
          if(value == 'tigrai tv') navigateTo(ROUTES.MAIN_TAB.TV.LIST.LATEST)
          else  navigateTo(ROUTES.MAIN_TAB.TV.LIST.GROUP_CATEGORY,{cat:value})
        } else{
          //forName_ thier name
            ...
            {Object.keys(modelGroups.categories).map((cat,index) => (
              <View key={cat}    style={[flexStyles.crow,{justifyContent: 'center', alignItems: 'center' }]}> 
                  ...
                  <TouchableOpacity
                    ...
                    style={[
                      boxStyles.boxStyle_sm,borderStyles.border_flat_system,boxStyles.p_lrmd,
